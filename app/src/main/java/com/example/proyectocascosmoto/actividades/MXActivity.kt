...
class MXActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Configura los textos de los modelos específicos para "MX"
        findViewById<ImageButton>(R.id.amEstrella1).tag = "amEMX1" // Estrella MX 1
        findViewById<ImageButton>(R.id.amEstrella2).tag = "amEMX2" // Estrella MX 2
        findViewById<ImageButton>(R.id.amEstrella3).tag = "amEMX3" // Estrella MX 3
        findViewById<ImageButton>(R.id.amEstrella4).tag = "amEMX4" // Estrella MX 4
        findViewById<ImageButton>(R.id.amEstrella5).tag = "amEMX5" // Estrella MX 5


        val starButtons4: MutableList<ImageButton> = ArrayList()
        starButtons4.add(findViewById(R.id.amEstrella1))
        starButtons4.add(findViewById(R.id.amEstrella2))
        starButtons4.add(findViewById(R.id.amEstrella3))
        starButtons4.add(findViewById(R.id.amEstrella4))
        starButtons4.add(findViewById(R.id.amEstrella5))

        val MXsharedPreferences = getSharedPreferences("StarPrefs", Context.MODE_PRIVATE)




        for (button in starButtons4) {
            ...
            val isFavorite = MXsharedPreferences.getBoolean(button.tag.toString(), false)

            // Verifica si la información se ha guardado en SharedPreferences
            val isSaved = MXsharedPreferences.contains(button.tag.toString())
            ...
            button.setOnClickListener { toggleStarState(button, MXsharedPreferences) }
    ...
    private fun toggleStarState(button: ImageButton, sharedPreferences: SharedPreferences) {
        ...
        Log.d("MXActivity", "toggleStarState() called")
    ...
    private fun updateStarImage(button: ImageButton, isFavorite: Boolean) {
        ...
        Log.d("MXActivity", "updateStarImage() called")
